...
(function ($, window, document) {
    ...
    SearchableOptionList.prototype = {
        ...
        defaults: {
            ...
            texts: {
                noItemsAvailable: 'Dato no encontrado',
                selectAll: 'Seleccionar todo',
                selectNone: 'Desmarcar todos',
                quickDelete: '&times;',
                searchplaceholder: 'Haga clic aquí para buscar',
                loadingData: 'Todavía cargando datos...',
                itemsSelected: '{$a} artículos seleccionados'
            },
    ...
    $.fn.searchableOptionList = function (options) {
        ...
        this.each(function () {
            ...
            if ($alreadyInitializedSol) {
                ...
                $alreadyInitializedSol.$container.html(''); var newSol = new SearchableOptionList($this, options); result.push(newSol); setTimeout(function () { newSol.init(); }, 0);
            } else {
