...
{
    [Authorize]
    public class ManageController : BrowseController
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetTwoFactorSuccess ? "Se ha establecido su proveedor de autenticación de dos factores."
                ...
                : message == ManageMessageId.RemovePhoneSuccess ? "Se ha eliminado su número de teléfono."
                : "";
